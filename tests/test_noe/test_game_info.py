...
class TestGameInfo(TestCase):
    ...
    def test_game_info_3ds(self):
        ...
        self.assertEqual(
            game.slug,
            "/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
        ...
        self.assertEqual(
            game.eshop.at_de,
            "https://www.nintendo.at/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
        self.assertEqual(
            game.eshop.be_fr,
            "https://www.nintendo.be/fr/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
        self.assertEqual(
            game.eshop.be_nl,
            "https://www.nintendo.be/nl/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
        self.assertEqual(
            game.eshop.ch_de,
            "https://www.nintendo.ch/de/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
        self.assertEqual(
            game.eshop.ch_fr,
            "https://www.nintendo.ch/fr/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
        self.assertEqual(
            game.eshop.ch_it,
            "https://www.nintendo.ch/it/Games/Nintendo-3DS-games/Super-Smash-Bros-for-Nintendo-3DS-864329.html",
        )
    ...
    def test_game_info_switch(self):
        ...
        self.assertEqual(
            game.eshop.au_en, "https://ec.nintendo.com/AU/en/titles/70010000012331"
        )
        self.assertEqual(
    ...
    def test_game_info_wiiu(self):
        ...
        self.assertEqual(
            game.slug, "/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html"
        )
        ...
        self.assertEqual(
            game.eshop.de_de,
            "https://www.nintendo.de/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html",
        )
        self.assertEqual(
            game.eshop.es_es,
            "https://www.nintendo.es/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html",
        )
        self.assertEqual(
            game.eshop.fr_fr,
            "https://www.nintendo.fr/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html",
        )
        self.assertEqual(
            game.eshop.it_it,
            "https://www.nintendo.it/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html",
        )
        self.assertEqual(
            game.eshop.nl_nl,
            "https://www.nintendo.nl/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html",
        )
        self.assertEqual(
            game.eshop.pt_pt,
            "https://www.nintendo.pt/Games/Wii-U-games/Super-Smash-Bros-for-Wii-U-864849.html",
        )
